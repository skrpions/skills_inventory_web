...
export class InMemDataService implements InMemoryDbService {
  private users: User[] = [
    ...
    },
    {
      ...
      avatar: './assets/images/avatars/sho.jpeg',
      role: 'Administrator',
    },
    {
      id: 3,
    ...
    {
      id: 4,
      username: 'ng-dreamcode',
      password: 'ng-dreamcode',
      name: 'Dreamcode',
      email: 'dream@dreamcodesoft.com',
    ...
    },
    {
      ...
      email: 'leonardo.vargas@dreamcodesoft.com',
      avatar: './assets/images/avatars/avatar-10.jpg',
      role: 'Manager',
      refresh_token: true,
    },
    {
      ...
      password: 'ng-dreamcode',
      name: 'Eliana Zapata',
      email: 'eliana.zapata@dreamcodesoft.com',
      avatar: './assets/images/avatars/avatar-dreamcode.jpeg',
      role: 'Administrator',
      refresh_token: true,
    },
  ...
  private login(reqInfo: RequestInfo) {
    ...
    return from(this.users).pipe(
      find(user => user.email === email || user.email === email),
      map(user => {
        if (!user) {
